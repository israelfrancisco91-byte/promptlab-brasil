  ...
  return (
     <div className="min-h-screen text-white font-sans p-4 relative z-0">
      ...
      <style jsx global>{`
        ...
        .note-btn { background: rgba(30, 41, 59, 0.8); border: 1px solid #334155; padding: 12px 0; border-radius: 8px; font-weight: bold; cursor: pointer; transition: 0.2s; color: #cbd5e
